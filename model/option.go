...
func InitOptionMap() {
	...
	common.OptionMap["AntomPrivateKey"] = setting.AntomPrivateKey
	common.OptionMap["AntomPublicKey"] = setting.AntomPublicKey
	common.OptionMap["AntomGateway"] = setting.AntomGateway
	common.OptionMap["AntomPaymentMethodType"] = setting.AntomPaymentMethodType
	...
	common.OptionMap["TeamManagementEnabled"] = strconv.FormatBool(operation_setting.TeamManagementEnabled)
	common.OptionMap["TeamV3Enabled"] = strconv.FormatBool(operation_setting.TeamV3Enabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "TeamManagementEnabled":
			operation_setting.TeamManagementEnabled = boolValue
		case "TeamV3Enabled":
			operation_setting.TeamV3Enabled = boolValue
	...
	case "AntomPrivateKey":
		setting.AntomPrivateKey = value
	case "AntomPublicKey":
		setting.AntomPublicKey = value
	case "AntomGateway":
		setting.AntomGateway = value
	case "AntomPaymentMethodType":
		setting.AntomPaymentMethodType = value
	case "AntomCurrency":
