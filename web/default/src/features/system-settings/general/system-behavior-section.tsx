    ...
    <SettingsSection title={t('System Behavior')}>
      <Form {...form}>
        <SettingsForm onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <FormField
            control={form.control}
            name='TeamManagementEnabled'
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  <FormLabel>团队管理</FormLabel>
                  <FormDescription>
                    启用后侧边栏显示「团队管理」入口（邀请制分布式团队）；关闭后对所有用户隐藏
                  </FormDescription>
                </SettingsSwitchContent>
                <FormControl>
                  <Switch
          ...
          <FormField
            ...
            render={({ field }) => (
              <SettingsSwitchItem>
                <SettingsSwitchContent>
                  <FormLabel>企业团队</FormLabel>
                  <FormDescription>
                    启用后侧边栏显示「企业团队」入口及管理员的「企业团队管理」页；关闭后对所有用户隐藏
                  </FormDescription>
                </SettingsSwitchContent>
                <FormControl>
                  <Switch
