    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          AntomPrivateKey: settings.AntomPrivateKey ?? '',
          AntomPublicKey: settings.AntomPublicKey ?? '',
          AntomGateway:
            settings.AntomGateway ?? 'https://open-sg-global.alipay.com',
          AntomPaymentMethodType: settings.AntomPaymentMethodType ?? 'ALIPAY_CN',
