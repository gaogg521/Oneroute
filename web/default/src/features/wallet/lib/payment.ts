...
/**
 * Check if payment method is Antom (Alipay overseas).
 *
 * Antom returns a hosted cashier URL as `pay_link`, so it follows the same
 * window.open dispatch path as Stripe rather than the epay form submission.
 */
